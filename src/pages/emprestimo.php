...
.container .containerGen .modalContainer .modal-body form textarea, .container .containerGen .modalContainer .modal-body form select {
  margin: 0.2rem;
  padding: 0.6rem;
  width: 100%;    
}

.container .containerGen .modalContainer .modal-body form label {
...
.container .containerGen .modalContainer .modal-body form .numberBox span input{
    width: 100%;
}

.container .containerGen .modalContainer .modal-body form .numberBox input, .container .containerGen .modalContainer .modal-body form .numberBox span {
    width: 50%;
    margin: 0.2rem;
    padding: 0.6rem;
}
...
.container .containerGen table tr td button {
    background: none;
    cursor: pointer;
}

.container .containerGen table tr td a i, .container .containerGen table tr td button i {
  color: rgba(0, 0, 0, 0.5);
  font-size: 20px;
}

.container .containerGen table tr td a i:hover, .container .containerGen table tr td button i:hover {
  color: green;
}
