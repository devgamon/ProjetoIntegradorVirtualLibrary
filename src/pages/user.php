    ...
    <div class="container">
        ...
        <div class="containerGen">
            <div class="header">
                ...
                <p>Você pode adicionar, visualizar e editar novos usuários.</p>
            </div>

            <div class="modalContainer">
                <button class="btnAdd" id="open-modal"><i class="fa-solid fa-plus"></i> Adicionar Usuário</button>
                ...
                <div id="modal" class="hide">
                    ...
                    <div class="modal-body">
                        <form method="POST">
                            ...
                            <input type="text" name="genero" id="genero" placeholder="Gênero (M) or (F)">
            ...
            <?php
                if(isset($_POST['rm'],$_POST['nome'],$_POST['email'],$_POST['senha'],$_POST['telefone'],$_POST['dt_nascimento'],$_POST['genero'])){
                    CadastrarUsuario($_POST['rm'],$_POST['nome'],$_POST['email'],$_POST['senha'],$_POST['telefone'],$_POST['dt_nascimento'],$_POST['genero']);
                }
                ?>
